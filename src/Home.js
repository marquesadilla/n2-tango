        ...
        return(
            <React.Fragment>
                ...
                <div className="homeButtonContainer">
                    ...
                    <Link to={`/kanji?set=${kanjiSetClick}`}><button disabled onClick={this.clickedKanjiSet} value="u1-tango-1" className="btn from-left">友達</button></Link>
                    <Link to={`/kanji?set=${kanjiSetClick}`}><button disabled onClick={this.clickedKanjiSet} value="u1-tango-1" className="btn from-left">知人・付き合い</button></Link>
                    <Link to={`/kanji?set=${kanjiSetClick}`}><button disabled onClick={this.clickedKanjiSet} value="u1-tango-1" className="btn from-left">恋人</button></Link>
                    <Link to={`/kanji?set=${kanjiSetClick}`}><button disabled onClick={this.clickedKanjiSet} value="u1-tango-1" className="btn from-left">関係悪化</button></Link>
                    {/*
